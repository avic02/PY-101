...
for height in student_heights :
    total_height += height  # += inside the for-in Loop means it will keep adding to the variable(list/int) on repeat
print(total_height)
...
for number in range(1,11,3):  # Here '3' denotes the step meaning it will return every 3rd number starting from 1.
    print(number)
...
for number in range(1,101):
    ...
    if number % 5 == 0 and number % 3 == 0:
     ...
     print(f"you have picked a very moody digit there {number}")           
